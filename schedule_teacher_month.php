...
<script>
    ...
    optionsBlock.prepend(`<h1 class="container_group"> ${getTeacherData().name} </h1>`);
    ...
    function generateLessons(date, lessons) {
        ...
        _(lessons.sort(function (lesson1, lesson2) {
            ...
            const groups = _(lessonRangeForLessonNumber).map('GroupCode').uniq().value().join(', ')
            ...
            for (let i = 0; i < amount; i++) {
                ...
                $(` <div class="slide_month_day" data-date="${dateObject.format('DD.MM.YYYY')}">
                    ...
                    .append(generateLessons(
                        ...
                        lessons.filtrateByTeacher().trimSession().getTable().filter(function (lesson) {
