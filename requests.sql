...
SELECT CONVERT(CHAR(32), УчебныеГруппы._IDRRef, 2) AS id,
       ...
       Институты._Code                             AS departmentCode
FROM _Reference176 AS УчебныеГруппы
         LEFT JOIN _Reference151 AS Институты
                   ON УчебныеГруппы._Fld1234RRef = Институты._IDRRef
...
WHERE РегистрДисциплины._Fld7246RRef = 0x80DF000C295831C111EBC7A8E96D12AE
  -- 2021/2022  0x80DF000C295831C111EBC7A8E96D12AE
  --AND РегистрДисциплины._Fld7251RRef = :studentGroupId /* Учебная группа*/
  AND CONVERT(VARCHAR(10), ДниПроведенияЗанятий._Fld7241, 104) = '24.05.2022'
  AND Семестры._IDRRef = 0x80C4000C299AE95511E6FFDE22A08A7D
  --AND Институты._Fld152 = :departmentCode
  AND Институты._Fld152 = N'ИТ'
