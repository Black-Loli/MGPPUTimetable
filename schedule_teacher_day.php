...
<script>
    ...
    $(`.tools_block`).find('.professor_name').html(`${getTeacherData().name}`)
	...
	// getTimeTable(function (timeTableHandler) {
	// 	const lessonsArray = timeTableHandler.getCurrentDayLessons().filtrateByTeacher().getTable()
	// 	if (lessonsArray.length > 0) {
	// 		generateSlides(lessonsArray.length);
	// 		$('.empty-holder').addClass('empty');
	// 	}
